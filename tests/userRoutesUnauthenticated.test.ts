...
import { getUserFollowers, getUserFollowing, isUserFollowerOfUser, makeUserFollowUser } from "../src/data-access/users";
...
describe("User Routes", () => {
    ...
    describe("POST /users/profile/:id/toggleFollow", () => {
        it("should give 404 if no user found or user not logged in", async () => {
            ...
            (makeUserFollowUser as jest.Mock).mockResolvedValue(null);
    ...
    describe("GET /users/profile/:id", () => {
        it("should return user profile", async () => {
            ...
            (getUserFollowers as jest.Mock).mockResolvedValue([]);
